...
\begin{remark}
    ...
    \begin{enumerate}
        ...
        \end{align*}
        Da die Menge aller $[u]$ dicht liegt, folgt $\varphi_f(a) x_f = [a]$ für alle $a \in \Aa$. Außerdem erhalten wir, dass $\varphi_f(\Aa) = \Aa/_{N_f}$ dicht liegt, womit $x_f$ zyklisch ist. Zuletzt folgt
        \begin{align*}
