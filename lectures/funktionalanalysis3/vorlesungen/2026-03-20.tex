\subsection*{20.03.2026}

Sei $X$ ein $\C$-Vektorraum und seien $X_i, i \in I$ topologische $\C$-Vektorräume, $R_i : X \to X_i$ linear und $(R_i)_{i \in I}$ punktetrennend. Dann können wir $X$ mit der initialen Topologie versehen, um $X$ zu einem topologischen Vektorraum zu machen.
...
Ähnlich dazu setzen wir $R_{y,f}(T) = f(Ty)$, für $y \in Y_1, f \in Y_2'$. Die von diesen Abbildungen erzeugte initiale Topologie heißt die \emph{schwache Operatortopologie} auf $X$, wir schreiben $\Tc_w$.
...
da Kommutanten SOT-abgeschlossen sind (was in der Übung gezeigt wurde).
...
Für $R \in \Aa_r$ folgt $R(G) \leq G$ und $R^*(G) \leq G$. Dann folgt für $z, y \in H^r$
$$ (R P_G z, y) = (P_G R P_G z, y) = (P_G z, R^* P_G y) = (z, R^* P_G y) = (P_G R z, y). $$
Also ist $P_G \in \Aa_r^\updownarrow$. Aus dem oben Gezeigten folgt, wegen $L \in \Aa_r^{\updownarrow\updownarrow}$,
