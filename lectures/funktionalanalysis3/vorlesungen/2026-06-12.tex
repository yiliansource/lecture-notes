...
\[
    \vert \tr(T) \vert
    \leq
    \sum_{e \in E} \vert \langle Te, e \rangle_H \vert
    \leq
    \Vert T \Vert_1
    <
    \infty
\]
konvergiert die Summe sogar absolut.
...
\begin{remark}{\ }
    \begin{enumerate}
        ...
        \end{align*}
        Insbesondere hängt die Definition der Spur nicht von der Wahl einer Orthonormalbasis ab.
...
Wir erinnern uns, dass $(\ell^1)' = \ell^\infty$ und $(c_0)' = \ell^1$. Im Folgenden wollen wir ein Analogon dieser Tatsache für Operatoren auf einem Hilbertraum realisieren.
...
Sei $T \in S_1(H)$, so können wir schreiben
\[
