...
\begin{remark}
    ...
    \]
    wobei die Reihe sogar gleichmäßig in der Operatornorm konvergiert und $N \in \N \cup \{\infty\}$. Dabei ist $(u_n)$ ein Orthonormalsystem, $\{ \lambda_n \}_{n = 1}^N = \sigma(A) \setminus \{0\}$. Weiters können wir die $\lambda_k$ monoton fallend anordnen.
\end{remark}
...
\begin{proof}
    ...
    \]
    Für ein $x \in H_1$ mit $\Vert x \Vert \leq 1$, und $P_M$ der orthogonalen Projektion auf $\spn M$, gilt
    \begin{align*}        
        ...
        &\leq
        \left( \sum_{e \in E} \vert \langle x, e \rangle^2 \right) \left( \sum_{e \in E \setminus M} \Vert T e \Vert^2 \right)
        \leq
        \Vert x \Vert^2 \varepsilon
        \leq
        \varepsilon.
    \end{align*}
