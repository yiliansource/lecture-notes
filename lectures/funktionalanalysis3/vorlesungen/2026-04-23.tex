...
\begin{proposition}
    Sei $\Aa$ eine $C^*$-Algebra ohne Eins. Dann ist
    $$ \mathscr{W} \coloneqq \psi(\Aa) \overset{\cdot}{+} \spn(\id_\Aa) \leq L_b(\Aa) $$
    eine Unter-Banachalgebra und eine $C^*$-Algebra mit
...
\begin{proof}{\ }
    \begin{itemize}
        ...
        \begin{align*}
            ...
            &\leq
            \Vert x^* \Vert \ \Vert (\psi(a) + \lambda I)(\psi(a) + \lambda I)^* \Vert \ \Vert x \Vert \\
            &=
            \Vert (\psi(a) + \lambda I)(\psi(a) + \lambda I)^* \Vert \ \Vert x \Vert^2. \qedhere
        \end{align*}
    \end{itemize}
\end{proof}
...
Wir erkennen unmittelbar, dass $\Aa \vartriangleleft \eAa$ und $\codim \Aa \leq 1$.
...
\begin{remark}
    ...
    \begin{itemize}
        ...
        \item Für $a \in \Aa_+$ gilt auch\footnote{A priori wissen wir nur $\sqrt[n]{a} \in \eAa$!} $\sqrt[n]{a} \in \Aa$, da $\Aa$ prim ist.
        ...
        \item Insgesamt haben wir $\Aa \vartriangleleft \eAa$, wobei Letzteres nach Gelfand--Naimark--Segal eingebettet werden kann in $L_b(H)$ für einen Hilbertraum $H$. Insbesondere ist also auch $\Aa$ isometrisch isomorph zu einer Unteralgebra von $L_b(H)$.
    \end{itemize}
\end{remark}