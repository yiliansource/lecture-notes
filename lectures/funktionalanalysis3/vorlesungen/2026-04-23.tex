...
\begin{remark}
    ...
    \begin{itemize}
        ...
        \item Für $a \in \Aa_+$ gilt auch\footnote{A priori wissen wir nur $\sqrt[n]{a} \in \Aa_+$!} $\sqrt[n]{a} \in \Aa$, da $\Aa$ prim ist.
        \item Es gilt $\Aa_{sa} = \Aa_+ - \Aa_+$ und damit $\Aa = \Aa_+ - \Aa_+ + i \Aa_+ - i \Aa_+$.
        \item Ist $\Aa$ kommutativ, so ist auch $\eAa$ kommutativ.
        \item Sei $\Aa$ kommutativ. Dann wissen wir $\eAa \cong C_b(M_{\eAa}, \C)$. (Muss ich noch ausführen.)
